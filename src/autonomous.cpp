...
void runStandardAuto() {
  ...
  if(fieldSide == 1) {
    if(DEBUG) { std::cout << "RED side selected for 15sec autonomous \n "; }
  ...
  if(fieldSide == 2) {
    if(DEBUG) { std::cout << "BLUE side selected for 15sec autonomous \n "; }
...
void runSkillAuto(){
  ...
  // fieldSide lets us know this 1 == RED 2 == blue
  if(fieldSide == 1) {
    if(DEBUG) { std::cout << "RED side selected for 60sec autonomous \n "; }
  ...
  if(fieldSide == 2) {
    if(DEBUG) { std::cout << "BLUE side selected for 60sec autonomous \n "; }
    armAngle = liftMoveForAngle(65, 50 );        // move up 45degree from Zero point
    if(DEBUG) { std::cout << "Arm angle after move: " << armAngle << " \n";}
    pros::delay(5000);               // 5 sec (5000mSec) delay for testing purpose
